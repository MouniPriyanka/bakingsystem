...
<body>
	...
	<div class="content-section-a col-md-4 col-md-offset-5">
				<form class="form-inline" method="post" action="OtpForgotServlet">
					<div class="form-group">
						<div class="col-sm-10">
							<input type="text" class="form-control" id="otp" name="otp" placeholder="Enter OTP" class="form-control input-md" required>
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-10">
