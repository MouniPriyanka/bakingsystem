							...
							<c:forEach var="user" items="${listUsers.rows}">
								<tr>
									<td><input type="hidden" value="" id="" /> <input
										type="hidden" value="" id="" /> <input type="hidden" value=""
										id="" /></td>
									...
									<td align="center">
									  <form action="EditCustomerServlet" method="post" >
										<p data-placement="top"
											...
											<input class="btn btn-primary btn-sm"  type="submit" value="Edit" name="submitbtn" />
									...
									<td align="center"><input class="btn btn-primary btn-sm"  type="submit" value="AccountDetails" name="submitbtn" /></td>
